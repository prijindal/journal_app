...
void loginAndUser() async {
  HttpApi loginApi = new HttpApi();
  Timer(new Duration(seconds: 1), () async {
    // await loginApi.login("priyanshujindal1995@gmail.com","123456");
    var user = await loginApi.getUser();
    print(user);
    var data = await loginApi.getJournal();
    print(data);
  });
}
